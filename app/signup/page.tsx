    ...
    <div className="min-h-screen flex items-center justify-center bg-surface p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-container-low border border-outline-variant p-8">
          <h2 className="font-label text-[12px] uppercase tracking-[0.15em] border-b border-outline-variant pb-3 mb-6 text-on-surface text-center font-bold">
            Create an Account
          </h2>
          ...
          <div className="mt-6 text-center">
            <span className="font-body text-xs text-on-surface-variant">Already have an account? </span>
            <button
              type="button"
