...
@theme inline {
  ...
  /* Color tokens — will be overridden by dark class */
  ...
  --color-accent: #a33800; /* punchy orange */
}

/* ===== LIGHT MODE (Stitch Editorial) ===== */
:root {
  --surface: #fcf8f8;
  --surface-dim: #dcd9d9;
  ...
  --tertiary: #485c00;
  --tertiary-container: #5d7600;
  --tertiary-fixed: #c3f400;
  --on-tertiary-container: #d9ff67;
